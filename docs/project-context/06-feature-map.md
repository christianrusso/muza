...
| Bloqueo social y métricas | Implementado | `src/app/(app)/profile/settings/blocked-users`, `src/app/admin/(dashboard)/analytics/blocks`, `src/lib/community/blocks` | `specs/feat-2-block-another-user/` |
...
- [Feature 2 — Bloquear a otro usuario](../../specs/feat-2-block-another-user/README.md)
