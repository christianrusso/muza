...
- bloqueo social entre usuarios, con ocultamiento mutuo y desbloqueo desde configuración;
...
El panel admin actual mide usuarios, análisis, scores, comunidad y embudo de activación.
También ofrece métricas específicas de bloqueos en `/admin/analytics/blocks`, calculadas
desde el historial persistido. PostHog mide el embudo de adquisición/activación y eventos
de producto.
