  ...
  return (
    <div className="ph-dark relative flex min-h-dvh flex-col items-center justify-center gap-[22px]">
      ...
      <div className="relative flex items-center justify-center">
        <div className="spinner" style={{ width: 108, height: 108, borderTopColor: "var(--violet)" }} />
        <MaterialIcon name="palette" size={38} className="absolute text-[var(--violet)]" />
      </div>
...
// useSearchParams obliga a un límite de Suspense (si no, el prerender de
// producción falla). El trabajo real vive acá adentro; el default export lo
// envuelve.
function AnalyzingColorimetry() {
  ...
  return <AnalyzingSpinner />;
}

export default function AnalyzingColorimetryPage() {
  return (
    <Suspense fallback={<AnalyzingSpinner />}>
      <AnalyzingColorimetry />
    </Suspense>
  );
}
